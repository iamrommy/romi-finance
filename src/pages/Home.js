    ...
    <div>
      <div id="trading" className="text-white max-w-7xl mx-auto min-w-[320px]">
        <div className="px-5 xsm:px-10">
          <div className="my-16">
            <h1 className="font-poppins text-3xl xxsm:text-[2.7rem] xsm:text-[3.5rem] max-w-2xl flex flex-wrap leading-tight">
              Decentralized Perpetual Exchange
            </h1>
            <h4 className="text-base xsm:text-xl max-w-sm leading-tight my-4 text-slate-300">
      ...
      <div
        id="Break"
        className="w-full border-b border-neutral-500 mt-24 mb-16 min-w-[320px]"
      ></div>
      ...
      <div id="Tokens" className="text-white max-w-7xl mx-auto min-w-[320px]">
        <div className="px-5 xsm:px-10">
          <div
            id="details"
            className="flex flex-wrap w-full gap-y-8 justify-between mb-24"
          >
            ...
            <div className="flex flex-col max-w-xs">
              ...
              <p className="text-lg text-slate-300 leading-tight">
                ...
                swap from any supported asset into the position of your choice.
              </p>
            </div>
          </div>
