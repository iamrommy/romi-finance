  ...
  return (
    <div className='min-w-[320px]'>
        ...
        <div className='hidden lg:flex text-[#a7a7a9]'>
          ...
          <div className="px-2 xl:px-4 flex items-center relative">
            ...
            <div id="shortMenu" className='absolute w-40 p-7 rounded-xl shadow-2xl shadow-black bg-[#191919] space-y-7 top-14' hidden onMouseEnter={visibleShortMenu} onMouseLeave={hideShortMenu}>
              <div><NavLink to="/nft/mint"><div className='hover:text-white hover:cursor-pointer'>MINT</div></NavLink></div>
              <div><NavLink to="/nft/stakenft"><div className='hover:text-white hover:cursor-pointer'>Stake NFT</div></NavLink></div>
            </div>
          </div>
          <NavLink to="/ecosystem"><div className='px-2 xl:px-4 hover:cursor-pointer h-full flex items-center hover:text-white'>Ecosystem</div></NavLink>
          <NavLink to="/about"><div className='px-2 xl:px-4 hover:cursor-pointer h-full flex items-center hover:text-white'>About</div></NavLink>
        </div>
      ...
      <div id='slider' className='absolute inset-0 backdrop-blur-2xl shadow-black shadow-2xl w-80 h-full text-[#b8b8b8] -translate-x-80 transition-all ease-in-out lg:hidden overflow-y-scroll'>
        ...
        <NavLink to="/nft/mint"><div className='py-4 px-8 flex items-center'>Mint</div></NavLink>
        <NavLink to="/nft/stakenft"><div className='py-4 px-8 flex items-center'>Stake NFT</div></NavLink>
        <NavLink to="/ecosystem"><div className='p-3.5 flex items-center active:bg-[#2b2b2f]'>Ecosystem</div></NavLink>
        <NavLink to="/about"><div className='p-3.5 flex items-center active:bg-[#2b2b2f]'>About</div></NavLink>
      </div>
